...
VOLUNTARYCHECK=0
I=1
BOT=TeleErnest  # You can put here other bots. Also you can change it to run more than one bot in the same server.
...
echo -e "\033[38;5;208m            @Ernest_TM      \033[0;00m"
echo ""
cat << EOF
...
while getopts ":tsTSih" opt; do
  case $opt in
	...
	echo -e "\e[1m"
	echo -e ""
	echo "steady.sh bash script v1 Ernest TM" >&2
	echo ""
	echo -e "\e[0m"
